...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("  результат: run: " + cat.running(200));
        System.out.println("  результат: swim: " + cat.swimming(200));
        System.out.println("  результат: jump: " + cat.jumping(1.5));

        System.out.println();

        System.out.println("  результат: run: " + dog.running(500));
        System.out.println("  результат: swim: " + dog.swimming(200));
        System.out.println("  результат: jump: " + dog.jumping(1.5));
